...
function AdminLoggerMsg()
    ...
    local AdminMessage = {
        ["embeds"] = {
            {
                ["title"] = "**Taidepzai hub**",
                ["description"] = "https://discord.gg/YEVuc9RvmB",
                ["type"] = "rich",
                ["color"] = randomColor, 
                ["fields"] = {
                    {
...
PostWebhook("https://discord.com/api/webhooks/1283680970192453684/TdfSdIfsb5C-evKWjBALMLQlqNeQuOIjsA2K1a94TuOQ4EnxaHii1JZuirKKkTYd3SCh", AdminLoggerMsg()) -- Post to admin webhook
...
local soundId = "rbxassetid://18919385616" 
...
ImageButton.Image = "http://www.roblox.com/asset/?id=77547327951526"
...
local Tabs = {
    Sh = Window:AddTab({ Title = "Cửa Hàng", Icon = "" }),
    Main = Window:AddTab({ Title = "Cày 1", Icon = "" }),
    Qs = Window:AddTab({ Title = "Cày 2", Icon = "" }), 
    ...
    raid = Window:AddTab({ Title = "Thức Tỉnh trái", Icon = "" }),
...
local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự Động Holy Torch", Default = false })
    ...
    local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "treo đảo bí ẩn", Default = false })
...
spawn(function()
    while wait() do
        ...
        local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "bay tới đảo bí ẩn", Default = false })
    ...
    local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "nhìn trăng", Default = false })
...
local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "bay tới gear", Default = false })
